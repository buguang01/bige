...
func WebSocketReplyMsg(wsmd *WebSocketModel, et JsonMap, resultcom int32, jsdata interface{}) {
...
func WebSocketSendMsg(wsmd *WebSocketModel, action int32, jsdata interface{}) {
	jsresult := make(JsonMap)
